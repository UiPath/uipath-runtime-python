...
def test_disabled_guardrails_returns_fired_rule_for_matched_disabled_guardrail() -> (
    None
):
    ...
    policy_index = SimpleNamespace(get_rule=lambda rid: rule if rid == "R1" else None)
